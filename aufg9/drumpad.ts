namespace aufg9 {
	...
	// Beat
	let beat: string [] = [sounds[6], sounds[5], sounds[4], sounds[3], sounds[2], sounds[1], sounds[0]];
	
	let randomBeat: string [] = [sounds[0], sounds[1], sounds[2], sounds[3], sounds[4], sounds[5], sounds[6]];
