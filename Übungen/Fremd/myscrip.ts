namespace A7 {
	...
	let PopProzentDE = ((1 - population2008DE / population2022DE) * 100).toFixed(
		2
	);
	let PopProzentIT = ((1 - population2008IT / population2022IT) * 100).toFixed(
		2
	);
	let PopProzentFR = ((1 - population2008FR / population2022FR) * 100).toFixed(
		2
	);
	let PopProzentIR = ((1 - population2008IR / population2022IR) * 100).toFixed(
		2
	);
