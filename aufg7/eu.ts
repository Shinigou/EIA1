...
namespace aufg7 {
	...
	document.querySelector(".stars").addEventListener("click", function () {
		alterContent(
			...
			`${all2022.toLocaleString()} Mio`,
			`${(all2022 / all2022) * 100} %`,
			`${(((all2022 - all2008) / all2008) * 100).toLocaleString()} %`,
			`${(all2022 - all2008).toLocaleString()} Mio`,
			(all2022 / all2022) * 100
		);
	});
	...
	document.querySelector(".germany").addEventListener("click", function () {
		alterContent(
			"Deutschland",
			`${germany2022.toLocaleString()} Mio`,
			`${(germany2022 / germany2022) * 100} %`,
			`${(
				((germany2022 - germany2008) / germany2008) *
				100
			).toLocaleString()} %`,
			`${(germany2022 - germany2008).toLocaleString()} Mio`,
	...
	document.querySelector(".france").addEventListener("click", function () {
		alterContent(
			"Frankreich",
			`${france2022.toLocaleString()} Mio`,
			`${(france2022 / france2022) * 100} %`,
			`${(((france2022 - france2008) / france2008) * 100).toLocaleString()} %`,
			`${(france2022 - france2008).toLocaleString()} Mio`,
	...
	document.querySelector(".italy").addEventListener("click", function () {
		alterContent(
			"Italien",
			`${italy2022.toLocaleString()} Mio`,
			`${(italy2022 / italy2022) * 100} %`,
			`${(((italy2022 - italy2008) / italy2008) * 100).toLocaleString()} %`,
			`${(italy2022 - italy2008).toLocaleString()} Mio`,
	...
	document.querySelector(".denmark").addEventListener("click", function () {
		alterContent(
			"Dänemark",
			`${denmark2022.toLocaleString()} Mio`,
			`${(denmark2022 / denmark2022) * 100} %`,
			`${(
				((denmark2022 - denmark2008) / denmark2008) *
				100
			).toLocaleString()} %`,
			`${(denmark2022 - denmark2008).toLocaleString()} Mio`,
	...
	function alterContent(
		country: string,
		population22: string,
		popRelationEU: string,
		popGrowthRateSince08: string,
		popGrowthRateTotal: string,
		chartBar: number
	) {
		document.querySelector("h1").innerHTML = "Einwohnerzahl in " + country;
		document.querySelector(".p1").innerHTML =
			"Gesamtzahl Einwohner:innen in " + country + " in 2022";
		...
		document
			.querySelector(".chart")
			.setAttribute("style", "height:" + chartBar + "%");
	}
}
