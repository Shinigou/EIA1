...
(function (aufg7) {
    ...
    document.querySelector(".germany").addEventListener("click", function () {
        alterContent("Deutschland", `${germany2022.toLocaleString()} Mio`, `${(germany2022 / germany2022) * 100} %`, `${(((germany2022 - germany2008) / germany2008) *
            100).toLocaleString()} %`, `${(germany2022 - germany2008).toLocaleString()} Mio`, (germany2022 / all2022) * 100);
    });
    ...
    document.querySelector(".denmark").addEventListener("click", function () {
        alterContent("Dänemark", `${denmark2022.toLocaleString()} Mio`, `${(denmark2022 / denmark2022) * 100} %`, `${(((denmark2022 - denmark2008) / denmark2008) *
            100).toLocaleString()} %`, `${(denmark2022 - denmark2008).toLocaleString()} Mio`, (denmark2022 / all2022) * 100);
    });
